...
import { createLeadId, listLeadsForSite, persistLead, readLead } from "../lib/platform/leads/store";
import {
  activateRevision,
  rollbackPublication,
  resetOverlaysSafe,
...
async function main() {
  ...
  console.log("5. Rollback restores rev_001 without touching other tenants");
  const after = rollbackPublication("site_pilot_craft", "rev_001");
